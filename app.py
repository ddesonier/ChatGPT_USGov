...
endpoint = st.text_input("Enter the AOAI Endpoint", value="https://testdemo.openai.azure.us")
apikey = st.text_input("Enter a API Key", type="password")
apiversion = st.text_input("Enter a API Key", value="2024-05-01-preview")
model = st.text_input("Enter Model Deployment Name", value="testgpt4")
